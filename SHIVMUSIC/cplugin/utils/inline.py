...
buttons = InlineKeyboardMarkup(
    [
        ...
        [
            styled_button(text="『 𝐀ᴅᴅ 𝐌є 𝐁ᴀʙʏ 』", url="https://t.me/SHIVMUSICBOT?startgroup=true", style=ButtonStyle.SUCCESS)
        ],
    ]
)
...
def stream_markup(chat_id):
    return InlineKeyboardMarkup(
        [
            ...
            # Bottom Row: Add Me & Close merged (Space bachane ke liye!)
            [
                styled_button(text="『 𝐀ᴅᴅ 𝐌є 𝐁ᴀʙʏ 』", url="https://t.me/SHIVMUSICBOT?startgroup=true", style=ButtonStyle.SUCCESS),
                styled_button(text="✯ CLOSE ✯", callback_data="close", style=ButtonStyle.DANGER)
            ]
