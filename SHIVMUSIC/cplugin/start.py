...
def build_premium_start_caption(bot_name, user_mention):
    return (
        f"<b>✦ <tg-emoji emoji-id=\"6172312314423808834\">✨</tg-emoji> {bot_name} <tg-emoji emoji-id=\"5409025823388741707\">🎵</tg-emoji> ✦</b>\n\n"
        f"<b>ʜєʟʟσ {user_mention} <tg-emoji emoji-id=\"5246815495713207687\">👋</tg-emoji></b>\n"
        f"<b>ɪ'ϻ ʏσυʀ ғᴧsᴛ & ᴘσᴡєʀғυʟ ϻυsɪᴄ ᴘʟᴧʏєʀ.</b>\n\n"
        f"<tg-spoiler><b><tg-emoji emoji-id=\"5355051922862653659\">🤖</tg-emoji> ʙσᴛ ɪηғσʀϻᴧᴛɪση</b>\n\n"
        f"<b><tg-emoji emoji-id=\"6082387600599944892\">🎧</tg-emoji> ʜɪɢʜ-ǫυᴧʟɪᴛʏ ϻυsɪᴄ ᴘʟᴧʏєʀ</b>\n"
        f"<b><tg-emoji emoji-id=\"6100220081474639964\">⚡️</tg-emoji> ɪηsᴛᴧηᴛ & sϻσσᴛʜ sᴛʀєᴧϻɪηɢ</b>\n"
        f"<b><tg-emoji emoji-id=\"6271537028307881531\">💎</tg-emoji> ᴘʀєϻɪυϻ sσυηᴅ • ησ ʟᴧɢ</b>\n"
        f"<b><tg-emoji emoji-id=\"6032609071373226027\">👥</tg-emoji> ϻᴧᴅє ғσʀ ɢʀσυᴘs & ᴄʜᴧηηєʟs</b></tg-spoiler>\n\n"
        f"<b><tg-emoji emoji-id=\"5188540541922480562\">❓</tg-emoji> ᴛᴧᴘ ʜєʟᴘ ғσʀ ᴧʟʟ ᴄσϻϻᴧηᴅs</b>"
    )
...
async def start_pm(client, message: Message, _):
    ...
    if raw_caption:
        ...
        caption = build_premium_start_caption(bot_name_upper, user_mention)
