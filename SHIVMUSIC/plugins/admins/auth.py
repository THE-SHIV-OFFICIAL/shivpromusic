...
from SHIVMUSIC.utils import extract_user, int_to_alpha
...
from SHIVMUSIC.utils.decorators import AdminActual, language
from SHIVMUSIC.utils.inline import close_markup
from config import BANNED_USERS, adminlist


@app.on_message(
    filters.command(["auth", "cauth"], prefixes=["/", "!"]) & filters.group & ~BANNED_USERS
)
@AdminActual
...
@app.on_message(
    filters.command(["unauth", "cunauth"], prefixes=["/", "!"]) & filters.group & ~BANNED_USERS
)
@AdminActual
